			...
			foreach ($Resp_1 as $unico){
				$row_form1.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														...
														".($unico->idc01)." 
														<br>
														<div class='bullet_white'></div>  ".($unico->idc02)." - 
														".($unico->idc03)."
														</span>
														</div>
			...
			foreach ($Resp_2 as $unico){
				...
				$row_form2.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														...
														".($unico->idc02)."
														<br>
														<div class='bullet_white'></div> ".($unico->idc03)."
														<br>
														<div class='bullet_white'></div>" .($unico->idc04)." 
														".($unico->idc05)."
														<br> 

														<div class='bullet_white'></div> ".($unico->idc06)." - ".($unico->idc07)."
														<br>
														<div class='bullet_white'></div> ".($unico->idc08)."
														".($unico->idc09)."
														</span>
														".$archivo_certificado."
														</div>
			...
			foreach ($Resp_3 as $unico){
				...
				$row_form3.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														...
														".($unico->idc05)."
														<br>
														<div class='bullet_white'></div> ".($unico->idc07)."
														</span>
														".$archivo_certificado."
														</div>
														<div class='col-lg-2 col-xs-2'>	
			...
			foreach ($Resp_4 as $unico){
				...
				$row_form4.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														...
														<br>
														<div class='bullet_white'></div> ".($unico->idc02)."
														<br><div class='bullet_white'></div> ".($unico->idc03)."
														
														<br><div class='bullet_white'></div> ".($unico->idc04)." - ".($unico->idc05)."
														<br><div class='bullet_white'></div> ".($unico->idc07)."
			...
			foreach ($Resp_5 as $unico){
				...
				$row_form5.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														...
														<div class='bullet_lightBlue'></div> 
														".($unico->idc01)."
														<br><div class='bullet_white'></div> ".($unico->idc02)." - ".($unico->idc03)."
														</span>
														".$archivo_certificado."
														</div>
														<div class='col-lg-2 col-xs-2'>	
...
$id_form="7";
		...
		//print_r($Resp_5);
			...
			foreach ($Resp_7 as $unico){
				...
				$lugar="";
				if($unico->idc02<>""){
					$lugar.="<br><div class='bullet_white'></div> Sucursal 1: ".($unico->idc02)."";
				}
				if($unico->idc03<>""){
					$lugar.="<br><div class='bullet_white'></div> Sucursal 2: ".($unico->idc03)."";
				}
				if($unico->idc04<>""){
					$lugar.="<br><div class='bullet_white'></div> Sucursal 3: ".($unico->idc04)."";
				}								
				$row_form7.="<div class='row'>
													<div class='col-lg-10 col-xs-10'>
														<span style='display: inline;margin-top: 10px;font-weight: 600;color: #192857;font-size: 14px;  '>
														<div class='bullet_lightBlue'></div> 
														 Flexibilidad para trabajar en otra ciudad: ".($unico->idc01)."
														".$lugar."
														<br><div class='bullet_white'></div> Area de Inter&eacute;s: ".($unico->idc05)."
														</span>
														".$archivo_certificado."
														</div>
														<div class='col-lg-2 col-xs-2'>	
			...
			if(count($Map_sucesor_potencial)>0){
				foreach($Map_sucesor_potencial as $unico){
					...
					if($todes=="todes"){
							...
							//exit();
						  $PRINCIPAL = str_replace("{NOMBRE_CARGO_DIVISION}", (Potencial_abreviatura_sinutf8($rut_col_full[0]->division)), $PRINCIPAL);				
					} 
...
if(count($array_agradecimiento)>0){
    foreach ($array_agradecimiento as $unico) {		
        ...
        $row = str_replace("{MENSAJE_RECO}", 	($unico->mensaje), $row);			
...
if(count($array_reco)>0){
    ...
    foreach ($array_reco as $unico) {		
        ...
        $row2 = str_replace("{MENSAJE_RECO}", 	($unico->mensaje), $row2);			
    ...
    foreach ($array_AMON as $unico) {		
		...
		if($unico->acuse_recibo<>""){
			$acuse_recibdo="
					...
					<BR><span class='body'> ".($unico->mensaje)." </span>
...
if(count($array_cursos)>0){
    foreach ($array_cursos as $unico) {		
		...
		$row = str_replace("{CURSO}", 		($curso), $row);
        $row = str_replace("{FECHA}", 		($unico->fecha_inicio), $row);
        $row = str_replace("{APROBADO}", 	($unico->status), $row);
        $row = str_replace("{font_size}", 	($font_size), $row);
        $row = str_replace("{height_size}", 	($height_size), $row);
...
{   
		...
		$row_tbl_carrera_interna.="
						      ...
						      <li class=' ai-c py-4 fw-b c-brand bbw-1' style='{DISPLAY_CARGO_DENTRO_BANCO_FICHA_1}'>
						        <strong>".(Potencial_nomenclatura($unico->cargo_glosa))." </strong>: ".(($unico->fec_ini))." a ".(($unico->fec_ter))."
						      </li>	";			
						      //FechaDDMMYYYY
		}
		...
		$row_tbl_mc_tramo_desempeno.="
						      ...
						      <li class='d-flex ai-c py-4 fw-b c-brand bbw-1'>
						        ...
						        ".(($unico->tramo_gestion_desempeno))."</span>
						      </li>	";			
						      
		$row_tbl_mc_tramo_desempeno_ZONA.="
							  Zona Salarial: <span class='c-brand-weight'>".($unico->zona_salarial)."</span></span>
						     ";							      
						      //FechaDDMMYYYY
						$informacion_actualizada="<div class='txt_actualizada_al'>Informaci&oacute;n Actualizada al ".FechaDDMMYYYY($unico->fecha)."</div>";
		...
		if($display_full_comp==" display: none !important; "){
			...
			$row_tbl_mc_potencial_competencias.="
						      <li class='d-flex ai-c py-4 fw-b c-brand bbw-1' style='".$display_full_comp."'>
						        <div class='bullet_lightBlue'></div> <span style=''>Periodo: <strong>".($unico->periodo)."</strong></span>
						      </li>		
						      <li class='d-flex ai-c py-4 fw-b c-brand bbw-1' style='".$display_full_comp."'>
						        <div class='bullet_lightwhite'></div>Nota Final: <strong>".($unico->final)."</strong> 
						        ...
						        ".(($unico->final))."
						        <br>".(($unico->descendente))."
						        <span style='".$display_full_des_asc."'><br>".(($unico->ascendente))."</span>
						        </span>-->
						      </li>	";			
						      //FechaDDMMYYYY
		}		
...
if($row_tbl_mc_potencial_clima==""){
    ...
    $PRINCIPAL = str_replace("{ROW_TBL_BAC}", ($row_tbl_mc_potencial_bac), $PRINCIPAL);
		...
		$row_tbl_mc_potencial_relacionados.="
						      <li class='d-flex ai-c py-4 fw-b c-brand bbw-1' style='{DISPLAY_CARGO_DENTRO_BANCO_FICHA_1}'>
						        <div class='bullet_lightBlue'></div> <span class='c-brand-weight' style='font-family: 'nunito_sans_bold';padding-left: 5px;'>".($unico->estado)."</span> 
						      </li>		
						      ";			
						      //FechaDDMMYYYY
		}		
...
function Potencial_tbl_formularios_respuestas($PRINCIPAL, $rut_col){
		...
		//print_r($Resp_2);
		if($Resp_1[0]->idc01<>""){
			$PRINCIPAL = str_replace("{ESTADO_CIVIL}", 				($Resp_1[0]->idc01), $PRINCIPAL);
		} else {
		...
		$fecha_2=Potencial_tbl_formularios_respuestas_data_ultimaFecha($id_form, $rut_col);
			...
			if($Resp_2[0]->idc01==""){$display_profesion_ficha_1=" display:none !important; ";
				...
				$PRINCIPAL = str_replace("{INFORMACION_FORMACION_ACADEMICA_ACTUALIZADA}", 		$informacion_actualizada, $PRINCIPAL);
					...
					$PRINCIPAL = str_replace("{PROFESION_FICHA_1}", 		($Resp_2[0]->idc01), $PRINCIPAL);
					$PRINCIPAL = str_replace("{UNIVERSIDAD_FICHA_1}", 	($Resp_2[0]->idc02), $PRINCIPAL);
					$PRINCIPAL = str_replace("{DISPLAY_PROFESION_FICHA_1}", 	($display_profesion_ficha_1), $PRINCIPAL);
				
			if($Resp_2[0]->idc03==""){$display_profesion_ficha_2=" display:none !important; ";}
					$PRINCIPAL = str_replace("{PROFESION_FICHA_2}", 		($Resp_2[0]->idc03), $PRINCIPAL);
					$PRINCIPAL = str_replace("{UNIVERSIDAD_FICHA_2}", 	($Resp_2[0]->idc04), $PRINCIPAL);
					$PRINCIPAL = str_replace("{DISPLAY_PROFESION_FICHA_2}", 	($display_profesion_ficha_2), $PRINCIPAL);

			if($Resp_2[0]->idc05==""){$display_postgrado_ficha_1=" display:none !important; ";}
					$PRINCIPAL = str_replace("{POSTGRADO_FICHA_1}", 		($Resp_2[0]->idc05), $PRINCIPAL);
					$PRINCIPAL = str_replace("{UNIVERSIDAD_POSTGRADO_FICHA_1}", 	($Resp_2[0]->idc06), $PRINCIPAL);
					$PRINCIPAL = str_replace("{DISPLAY_POSTGRADO_FICHA_1}", 	($display_postgrado_ficha_1), $PRINCIPAL);

			if($Resp_2[0]->idc07==""){$display_postgrado_ficha_2=" display:none !important; ";}
					$PRINCIPAL = str_replace("{POSTGRADO_FICHA_2}", 		($Resp_2[0]->idc07), $PRINCIPAL);
					$PRINCIPAL = str_replace("{UNIVERSIDAD_POSTGRADO_FICHA_2}", 	($Resp_2[0]->idc08), $PRINCIPAL);
					$PRINCIPAL = str_replace("{DISPLAY_POSTGRADO_FICHA_2}", 	($display_postgrado_ficha_2), $PRINCIPAL);

			if($Resp_2[0]->idc09==""){$display_idioma_ficha_1=" display:none !important; ";}
		$PRINCIPAL = str_replace("{IDIOMA_FICHA_1}", 		($Resp_2[0]->idc09), $PRINCIPAL);
		$PRINCIPAL = str_replace("{NIVEL_IDIOMA_FICHA_1}", 	($Resp_2[0]->idc10), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_IDIOMA_FICHA_1}", 	($display_idioma_ficha_1), $PRINCIPAL);

		if($Resp_2[0]->idc11==""){$display_idioma_ficha_2=" display:none !important; ";}
		$PRINCIPAL = str_replace("{IDIOMA_FICHA_2}", 		($Resp_2[0]->idc11), $PRINCIPAL);
		$PRINCIPAL = str_replace("{NIVEL_IDIOMA_FICHA_2}", 	($Resp_2[0]->idc12), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_IDIOMA_FICHA_2}", 	($display_idioma_ficha_2), $PRINCIPAL);
		...
		if($Resp_4[0]->idc01==""){$display_cargo_anterior_ficha_1=" display:none !important; ";}		
		$PRINCIPAL = str_replace("{CARGO_ANTERIOR_FICHA_1}", 		($Resp_4[0]->idc01), $PRINCIPAL);
		if(isset($Resp_4[0]->idc02) && $Resp_4[0]->idc02==""){$Resp_4[0]->idc02="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{EMPRESA_ANTERIOR_FICHA_1}", 	($Resp_4[0]->idc02), $PRINCIPAL);
		if(isset($Resp_4[0]->idc03) && $Resp_4[0]->idc03==""){$Resp_4[0]->idc03="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_ANTERIOR_FICHA_1}", 	($Resp_4[0]->idc03), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_CARGO_ANTERIOR_FICHA_1}", 	($display_cargo_anterior_ficha_1), $PRINCIPAL);

		if($Resp_4[0]->idc04==""){$display_cargo_anterior_ficha_2=" display:none !important; ";}		
		$PRINCIPAL = str_replace("{CARGO_ANTERIOR_FICHA_2}", 		($Resp_4[0]->idc04), $PRINCIPAL);
		if(isset($Resp_4[0]->idc05) && $Resp_4[0]->idc05==""){$Resp_4[0]->idc05="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{EMPRESA_ANTERIOR_FICHA_2}", 	($Resp_4[0]->idc05), $PRINCIPAL);
		if(isset($Resp_4[0]->idc06) && $Resp_4[0]->idc06==""){$Resp_4[0]->idc06="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_ANTERIOR_FICHA_2}", 	($Resp_4[0]->idc06), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_CARGO_ANTERIOR_FICHA_2}", 	($display_cargo_anterior_ficha_2), $PRINCIPAL);

		if(isset($Resp_4[0]->idc07) && $Resp_4[0]->idc07==""){$display_cargo_anterior_ficha_3=" display:none !important; ";}
		$PRINCIPAL = str_replace("{CARGO_ANTERIOR_FICHA_3}", 		($Resp_4[0]->idc07), $PRINCIPAL);
		if(isset($Resp_4[0]->idc08) && $Resp_4[0]->idc08==""){$Resp_4[0]->idc08="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{EMPRESA_ANTERIOR_FICHA_3}", 	($Resp_4[0]->idc08), $PRINCIPAL);
		if(isset($Resp_4[0]->idc09) && $Resp_4[0]->idc09==""){$Resp_4[0]->idc09="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_ANTERIOR_FICHA_3}", 	($Resp_4[0]->idc09), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_CARGO_ANTERIOR_FICHA_3}", 	(($display_cargo_anterior_ficha_3)), $PRINCIPAL);
		...
		$PRINCIPAL = str_replace("{PROYECTO_FICHA_1}", 							($Resp_5[0]->idc01), $PRINCIPAL);
		if(isset($Resp_5[0]->idc02) && $Resp_5[0]->idc02==""){$Resp_5[0]->idc02="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{ROL_PROYECTO_FICHA_1}", 					($Resp_5[0]->idc02), $PRINCIPAL);
		if(isset($Resp_5[0]->idc03) && $Resp_5[0]->idc03==""){$Resp_5[0]->idc03="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_PROYECTO_FICHA_1}", 			($Resp_5[0]->idc03), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_PROYECTO_FICHA_1}", 			($display_proyecto_ficha_1), $PRINCIPAL);
		
		if(isset($Resp_5[0]->idc04) && $Resp_5[0]->idc04==""){$display_proyecto_ficha_2=" display:none !important; ";}
		$PRINCIPAL = str_replace("{PROYECTO_FICHA_2}", 							($Resp_5[0]->idc04), $PRINCIPAL);
		if(isset($Resp_5[0]->idc05) && $Resp_5[0]->idc05==""){$Resp_5[0]->idc05="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{ROL_PROYECTO_FICHA_2}", 					($Resp_5[0]->idc05), $PRINCIPAL);
		if(isset($Resp_5[0]->idc06) && $Resp_5[0]->idc06==""){$Resp_5[0]->idc06="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_PROYECTO_FICHA_2}", 			($Resp_5[0]->idc06), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_PROYECTO_FICHA_2}", 			($display_proyecto_ficha_2), $PRINCIPAL);

		if(isset($Resp_5[0]->idc07) && $Resp_5[0]->idc07==""){$display_proyecto_ficha_3=" display:none !important; ";}
		$PRINCIPAL = str_replace("{PROYECTO_FICHA_3}", 							($Resp_5[0]->idc07), $PRINCIPAL);
		if(isset($Resp_5[0]->idc08) && $Resp_5[0]->idc08==""){$Resp_5[0]->idc08="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{ROL_PROYECTO_FICHA_3}", 					($Resp_5[0]->idc08), $PRINCIPAL);
		if(isset($Resp_5[0]->idc09) && $Resp_5[0]->idc09==""){$Resp_5[0]->idc09="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_PROYECTO_FICHA_3}", 			($Resp_5[0]->idc09), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_PROYECTO_FICHA_3}", 			($display_proyecto_ficha_3), $PRINCIPAL);

		if(isset($Resp_5[0]->idc10) && $Resp_5[0]->idc10==""){$display_proyecto_ficha_4=" display:none !important; ";}
		$PRINCIPAL = str_replace("{PROYECTO_FICHA_4}", 							($Resp_5[0]->idc10), $PRINCIPAL);
		if(isset($Resp_5[0]->idc11) && $Resp_5[0]->idc11==""){$Resp_5[0]->idc11="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{ROL_PROYECTO_FICHA_4}", 					($Resp_5[0]->idc11), $PRINCIPAL);
		if(isset($Resp_5[0]->idc12) && $Resp_5[0]->idc12==""){$Resp_5[0]->idc12="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_PROYECTO_FICHA_4}", 			($Resp_5[0]->idc12), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_PROYECTO_FICHA_4}", 			($display_proyecto_ficha_4), $PRINCIPAL);

		if(isset($Resp_5[0]->idc13) && $Resp_5[0]->idc13==""){$display_proyecto_ficha_5=" display:none !important; ";}
		$PRINCIPAL = str_replace("{PROYECTO_FICHA_5}", 							($Resp_5[0]->idc13), $PRINCIPAL);
		if(isset($Resp_5[0]->idc14) && $Resp_5[0]->idc14==""){$Resp_5[0]->idc14="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{ROL_PROYECTO_FICHA_5}", 					($Resp_5[0]->idc14), $PRINCIPAL);
		if(isset($Resp_5[0]->idc15) && $Resp_5[0]->idc15==""){$Resp_5[0]->idc15="<span style='font-family: nunito_sans_regular;'>Sin informaci&oacute;n</span>";}
		$PRINCIPAL = str_replace("{PERIODO_PROYECTO_FICHA_5}", 			($Resp_5[0]->idc15), $PRINCIPAL);
		$PRINCIPAL = str_replace("{DISPLAY_PROYECTO_FICHA_5}", 			($display_proyecto_ficha_5), $PRINCIPAL);
			...
			if($Resp_3[0]->idc01==""){
				...
				$display_cargo_recomendacion_ficha_1=" display:none !important; ";
						if($Resp_3[0]->idc07<>""){
							...
							<br><div class='c-brand-weight'  style='color:#002464;text-align: justify;padding-left:0px !important'>".($Resp_3[0]->idc07)."</div>";
						} else {
							//echo "<h1>c</h1>";
		...
		$PRINCIPAL = str_replace("{DISPLAY_POTENCIAL_FICHA_1}", 		($display_cargo_recomendacion_ficha_1), $PRINCIPAL);

		$PRINCIPAL = str_replace("{RECOMENDACION_POTENCIAL_FICHA_1}", 		    ($Resp_3[0]->idc01), $PRINCIPAL);
		$PRINCIPAL = str_replace("{RECOMENDACION_PERIODO_FICHA_1}", 		    ($Resp_3[0]->idc02), $PRINCIPAL);
		$PRINCIPAL = str_replace("{RECOMENDACION_OBSERVACIONES_FICHA_1}", 		($Resp_3[0]->idc03), $PRINCIPAL);				
...
function Potencial_Talento_Sucesion_vista_fichas($PRINCIPAL, $rut, $division){
		...
		$PRINCIPAL = str_replace("{DIVISION_SELECCIONADA}", 	($division), $PRINCIPAL);
...
if(count($array_agradecimiento)>0){
    foreach ($array_agradecimiento as $unico) {
        ...
        $row .= file_get_contents("views/mi_equipo_consolidado/" . $id_empresa . "_mi_ficha_row_reco.html");
			...
			elseif($rut==$unico->rut_destinatario){ 
				$ico_reco		="<div class='far fa-heart fa-1x icon_mascon' title='Agradecimiento' style='display: inline; display: inline; '></div>";	
				$tipo_reco		="Agradecimiento - ".($unico->categorita);
				$class_reco		="info";
				$rut_reco		=$unico->rut_remitente;			
				//echo "<br>$rut_reco ".$unico->rut_remitente;
			}
...
function colocarListaEquipoReconocimientos($PRINCIPAL, $id_empresa, $rut)
{
    ...
    if ($unico2->tipo == "RECONOCIMIENTO") {
            $tipo_reco   = "<i class='i-plain-sm nobottommargin i-azul icon-star'></i> <STRONG>Reconocimiento de ".$unico2->remitente."</STRONG><BR>Mensaje:&nbsp;".($unico2->mensaje)."<br>Fecha: ".($unico2->fecha);
            $estilo_reco = "";
        } elseif ($unico2->tipo == "GRACIAS") {
            $tipo_reco   = "<i class='i-plain-sm nobottommargin i-azul far fa-heart'></i> <STRONG>Agradecimiento de ".$unico2->remitente."</STRONG><BR>Mensaje:&nbsp;".($unico2->mensaje)."<br>Fecha: ".($unico2->fecha);
            $estilo_reco = "";
        }
...
function colocarListaReconocimientosPorRut($PRINCIPAL, $id_empresa, $rut)
{
    ...
    $PRINCIPAL = str_replace("{ROW_REC_TABLA_RECONOCIMIENTOS_GRACIAS_RECIBIDOS_PERFIL}", ($row), $PRINCIPAL);
    $row       = "";
    ...
    $PRINCIPAL = str_replace("{ROW_REC_TABLA_RECONOCIMIENTOS_GRACIAS_ENVIADOS}", ($row), $PRINCIPAL);
...
function colocarListaReconocimientosPorEquipo($PRINCIPAL, $id_empresa, $rut)
{
    ...
    $PRINCIPAL = str_replace("{ROW_REC_TABLA_RECONOCIMIENTOS_GRACIAS_RECIBIDOS}", ($row), $PRINCIPAL);
    $row       = "";
